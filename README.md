...
## 产品定位
本产品旨在为1-12岁的幼年儿童提供的一款大自然科普学习类软件。


## 背景
- 1-12岁的幼年儿童正处于吸收知识的时候，对大自然的一切因素都感到非常的好奇。有时候家长因为不了解／不知道而不能回答出自己孩子提出的问题（如：这是什么动物、这是什么植物等）

- 通过对一系列的识别APP调查，几乎所有的识别APP目标用户都偏向幼年儿童以上，没有一款是针对幼年儿童设计的科普类APP。
    - 科普类的APP又不支持拍照识别功能，科普教育视频过于无趣，不针对幼年儿童设计。
