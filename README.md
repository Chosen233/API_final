...
## 目标
- 让幼年儿童在外游玩的时候能过通过本产品进行科普学习。（植物识别、动物识别、通用物体识别）
    游戏互动：
    - 动物影子游戏：识别过的动物汇集到一起，弄成一个动物影子游戏，提高幼年儿童的认知能力。
    - 画画游戏：识别过的植物／动物汇集到一起，弄成一个植物／动物绘本游戏，提高幼年儿童的认知能力与书写技能。
    - 回收游戏：学习对各种类型的垃圾进行分类和回收并培养责任感。
